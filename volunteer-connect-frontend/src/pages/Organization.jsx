      ...
      <div className="container">
        <div className="dash-head">
          ...
          <div className="dash-actions">
            ...
            <Link to="/opportunities" className="btn btn-primary">View Opportunities</Link>
          </div>
        </div>
        ...
        <div className="grid grid-2">
          ...
          <div className="card">
            ...
            <div className="grid grid-2">
              <div className="mini-stat card" style={{ padding: 14 }}>
                ...
                <div className="mini-stat-value" style={{ fontSize: 26 }}>—</div>
          ...
          <div className="card">
            <div className="section-head">
              ...
              <span className="p-muted" style={{ fontSize: 13 }}>Takes ~30 seconds</span>
            </div>
