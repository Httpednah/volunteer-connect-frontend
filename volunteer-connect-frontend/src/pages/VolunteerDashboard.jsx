      ...
      <div className="container">
        ...
        <div className="dash-head">
          <div>
            ...
            <p className="p-muted">Track opportunities and take action quickly.</p>
          </div>
        ...
        <div className="grid grid-3">
          <div className="card mini-stat">
            ...
            <div className="mini-stat-sub p-muted">Opportunities you can apply to</div>
          </div>
          ...
          <div className="card mini-stat">
            ...
            <div className="mini-stat-sub p-muted">Status tracking will appear here</div>
          </div>
          ...
          <div className="card mini-stat">
            ...
            <div className="mini-stat-value">—</div>
            <div className="mini-stat-sub p-muted">Confirm paid registrations</div>
          </div>
        </div>
                ...
                <div key={opp.id} className="dash-item">
                  <div className="dash-item-main">
                    ...
                    <div className="dash-meta">
                      <span className="badge">{opp.location || "Location TBA"}</span>
                      <span className="dash-dot">•</span>
                      <span className="p-muted" style={{ fontSize: 13 }}>
                        {opp.duration ? `${opp.duration} hour(s)` : "Flexible duration"}
                      </span>
                    </div>
                  </div>
